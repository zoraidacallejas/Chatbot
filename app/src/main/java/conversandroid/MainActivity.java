...
public class MainActivity extends VoiceActivity {
    ...
    private final String ACCESS_TOKEN = "INSERT YOUR BOT's CLIENT ACCESS TOKEN HERE";   //TODO: INSERT YOUR ACCESS TOKEN
        ...
        new AsyncTask<String,Void,AIResponse>() {
            ...
            protected AIResponse doInBackground(String... strings) {
                ...
                try {
                    ...
                    try {
                        speak("Could not retrieve a response from DialogFlow", "EN", ID_PROMPT_INFO);
